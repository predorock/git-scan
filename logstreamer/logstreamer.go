...
//from: https://github.com/kvz/logstreamer
...
func NewLogstreamerForWriter(prefix string, writer io.Writer) *Logstreamer {
	...
	return NewLogstreamer(logger, "stdout", "", false)
}
...
func NewLogstreamerForStderr(prefix string) *Logstreamer {
	...
	return NewLogstreamer(logger, "stderr", "", false)
}

func NewLogstreamer(logger *log.Logger, kind string, prefix string, record bool) *Logstreamer {
